Shader "examples/week 8/OceanRefrac"
{
    Properties 
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (Interpolators i) : SV_Target
            {
                ...
                float3 tangentSpaceNormal = warp_noise_unpack(_normalMap, uv + i.worldPos.xz/25);
                ...
                float3 backgroundBase = tex2D(_BackgroundTex, screenUV);
                ...
                //float3 baseColor = _shallowColor * backgroundBase;
                ...
                float3 color = (diffuse * _opacity) + (background * (1 - _opacity)); // + (background * (1 - _opacity))
